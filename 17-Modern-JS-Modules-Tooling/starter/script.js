...
// transpiling (with babel) code that hasn't been fully approved by ECMA yet (with experimental plugins)
// works now
class Person {
  greeting = 'Hey';
  constructor(name) {
...
// finds the first elem (es6)
// .find is NOT converted back to es6 by babel
// console.log(cart.find(el => el.quantity > 0));

// NOT converted back to es5
